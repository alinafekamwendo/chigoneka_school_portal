    ...
    menuItems: [
      {
        ...
        route: "#",
        children: [
          { label: "Admins", route: "/dashboard/admin/admins" },
          { label: "Teachers", route: "/dashboard/admin/teachers" },
          { label: "Parents", route: "/dashboard/admin/parents" },
          { label: "Students", route: "/dashboard/admin/students" },
        ],
      },
      {
        icon: (
        ...
        route: "#",
        children: [
          { label: "Time table", route: "/pages/settings" },
          { label: "Examination", route: "/pages/settings" },
          { label: "Announcements", route: "/pages/settings" },
          { label: "Concerns", route: "/pages/settings" },
          { label: "Classes", route: "/dashboard/admin/classes" },
        ],
      },
    ],
  },
  {
    menuItems: [
      ...
      },
      {
        ...
        route: "#",
        children: [
          { label: "Finances", route: "/dashboard/admin/finances" },
          { label: "Perfomance", route: "/dashboard/admin/perfomance" },
          { label: "Results", route: "/dashboard/admin/reports" },
        ],
      },
      {
        icon: (
